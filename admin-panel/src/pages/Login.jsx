  ...
  return (
    <Box sx={{ minHeight: '100vh', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: mode === 'dark' ? '#02040a' : '#f1f5f9', px: { xs: 2, sm: 4 }, py: 4, position: 'relative', overflow: 'hidden', boxSizing: 'border-box' }}>
      ...
      <Box
        ...
        sx={{
          position: 'absolute', top: { xs: '-5%', md: '-10%' }, left: { xs: '5%', md: '10%' }, width: { xs: '280px', md: '500px' }, height: { xs: '280px', md: '500px' },
      ...
      <Box
        ...
        sx={{
          position: 'absolute', bottom: { xs: '-5%', md: '-10%' }, right: { xs: '5%', md: '10%' }, width: { xs: '320px', md: '550px' }, height: { xs: '320px', md: '550px' },
      ...
      <Card
        ...
        sx={{
          width: '100%', 
          maxWidth: { xs: '100%', sm: '420px' }, // 👈 Desktop par fixed stretch, mobile par screen adaptive auto constraint
          p: { xs: 3, sm: 4 }, 
          borderRadius: '28px',
      ...
      >
        <Box textAlign="center" sx={{ mb: 4 }}>
          <Typography variant="h4" sx={{ fontFamily: '"Space Grotesk", sans-serif', fontWeight: 900, color: '#06b6d4', mb: 1, letterSpacing: '-0.5px', fontSize: { xs: '1.8rem', sm: '2.125rem' } }}>
            NEXUS OS
          </Typography>
        ...
        <form onSubmit={handleSubmit}>
          <Box>
            <TextField
              ...
              InputProps={{
                startAdornment: <InputAdornment position="start"><EmailIcon sx={{ color: '#06b6d4', fontSize: 20 }} /></InputAdornment>
              }}
              sx={{ mb: 3 }} 
            />
            
            <TextField
              label="Account Password" required fullWidth type="password"
              value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })}
              InputProps={{
                startAdornment: <InputAdornment position="start"><LockIcon sx={{ color: '#06b6d4', fontSize: 20 }} /></InputAdornment>
              }}
              sx={{ mb: 4 }} 
            />
            ...
            <Button
              ...
              sx={{
                ...
                boxShadow: '0 8px 25px rgba(6, 182, 212, 0.3)', mb: 1,
        ...
        <Box textAlign="center" sx={{ mt: 3 }}>
          <Typography variant="body2" sx={{ fontFamily: '"Plus Jakarta Sans"', color: theme.palette.text.secondary, fontWeight: 500 }}>
            New terminal admin?{' '}
            <Link component="button" onClick={() => setAuthView('register')} sx={{ color: '#06b6d4', fontWeight: 700, textDecoration: 'none', fontFamily: '"Plus Jakarta Sans"' }}>
              Create Account
            </Link>
          </Typography>
        </Box>
